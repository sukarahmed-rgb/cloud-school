...
export async function askAITutor() {
  ...
  const queryText = /** @type {HTMLInputElement} */ (
...
export async function generateAIQuiz() {
  ...
  try {
    ...
    /** @type {HTMLInputElement} */ (document.getElementById('teacher-quiz-title')).value =
      ctx.__('autoGeneratedQuizTitle');
    /** @type {HTMLInputElement} */ (document.getElementById('teacher-quiz-q')).value =
      parsed.question;
    /** @type {HTMLInputElement} */ (document.getElementById('teacher-quiz-oa')).value = parsed.A;
    /** @type {HTMLInputElement} */ (document.getElementById('teacher-quiz-ob')).value = parsed.B;
    /** @type {HTMLInputElement} */ (document.getElementById('teacher-quiz-oc')).value = parsed.C;
    /** @type {HTMLInputElement} */ (document.getElementById('teacher-quiz-od')).value = parsed.D;
    /** @type {HTMLInputElement} */ (document.getElementById('teacher-quiz-correct')).value =
      parsed.correct;
