...
const currentCheatDots = new Set();
...
const localData = {
  books: [
    {
      id: 'b1',
      title: 'ظƒظٹظ…ظٹط§ط، ط§ظ„طµظپ ط§ظ„ط¹ط§ط´ط± - ط§ظ„ظˆط­ط¯ط© ط§ظ„ط£ظˆظ„ظ‰',
      content:
        'ظ…ط±ط­ط¨ظ‹ط§ ط¨ظƒ ظپظٹ ظˆط­ط¯ط© ط§ظ„ظƒظٹظ…ظٹط§ط،. ظپظٹ ظ‡ط°ط§ ط§ظ„ط¯ط±ط³طŒ ط³ظ†طھط¹ط±ظپ ط¹ظ„ظ‰ ط§ظ„ط¹ظ†ط§طµط± ظˆط§ظ„ط±ظˆط§ط¨ط· ط§ظ„طھط³ط§ظ‡ظ…ظٹط© ظˆط§ظ„ط£ظٹظˆظ†ظٹط© ظˆطھظپط§ط¹ظ„ط§طھ ط§ظ„ط·ط§ظ‚ط© ظˆط§ظ„ط­ط±ط§ط±ط©.',
      audio: '',
    },
    {
      id: 'b2',
      title: 'طھط§ط±ظٹط® ظˆط­ط¶ط§ط±ط© ط§ظ„ظˆط·ظ† ط§ظ„ط¹ط±ط¨ظٹ',
      content:
        'ظ…ط±ط­ط¨ظ‹ط§ ط¨ظƒ ظپظٹ طھط§ط±ظٹط® ط§ظ„ط¹ط±ط¨ ط§ظ„ظ…ط¬ظٹط¯. ط³ظ†طھط¹ظ„ظ… ط§ظ„ظٹظˆظ… ط¹ظ† ط§ظ„ط­ط¶ط§ط±ط§طھ ط§ظ„ظ‚ط¯ظٹظ…ط© ط§ظ„طھظٹ ظ‚ط§ظ…طھ ظپظٹ ط´ط¨ظ‡ ط§ظ„ط¬ط²ظٹط±ط© ط§ظ„ط¹ط±ط¨ظٹط© ظˆط§ظ„ظ‡ظ„ط§ظ„ ط§ظ„ط®طµظٹط¨ ظˆظ…طµط± ط§ظ„ظپط±ط¹ظˆظ†ظٹط©.',
      audio: '',
    },
  ],
  assignments: [
    {
      id: 'a1',
      title: 'ظˆط§ط¬ط¨ ط§ظ„ط¹ظ„ظˆظ… ظˆط§ظ„ظپظٹط²ظٹط§ط، ط§ظ„ط£ظˆظ„',
      type: 'mcq',
      question: 'ظ…ط§ ظ‡ظˆ ط§ظ„ظ…ظƒظˆظ† ط§ظ„ط£ط³ط§ط³ظٹ ظ„ط؛ط§ط² ط§ظ„ط£ظˆط²ظˆظ†طں',
      options: {
        A: 'ط§ظ„ظ‡ظٹط¯ط±ظˆط¬ظٹظ†',
        B: 'ط§ظ„ط£ظƒط³ط¬ظٹظ† ط§ظ„ط«ظ„ط§ط«ظٹ',
        C: 'ط§ظ„ظ†ظٹطھط±ظˆط¬ظٹظ†',
        D: 'ط؛ط§ط² ط«ط§ظ†ظٹ ط£ظƒط³ظٹط¯ ط§ظ„ظƒط±ط¨ظˆظ†',
      },
      correct: 'B',
    },
    {
      id: 'a2',
      title: 'ط§ط®طھط¨ط§ط± ط§ظ„ظ„ط؛ط© ط§ظ„ط¹ط±ط¨ظٹط© ط§ظ„ظ…ظ‚ط§ظ„ظٹ',
      type: 'text',
      question:
        'ط§ظƒطھط¨ ظپظ‚ط±ط© ظ‚طµظٹط±ط© طھطھط­ط¯ط« ظپظٹظ‡ط§ ط¹ظ† ظپط¶ظ„ ط§ظ„ظ…ط¹ظ„ظ… ظپظٹ ط§ظ„ظ…ط¬طھظ…ط¹ ظˆط£ظ‡ظ…ظٹط© ط§ظ„ط¹ظ„ظ…طں',
      ideal:
        'ظٹط¹ط¯ ط§ظ„ط¹ظ„ظ… ط±ظƒظٹط²ط© ط§ظ„ظ…ط¬طھظ…ط¹ط§طھ ط§ظ„ط£ط³ط§ط³ظٹط©طŒ ظˆط§ظ„ظ…ط¹ظ„ظ… ظ‡ظˆ ط§ظ„ظ†ظˆط± ط§ظ„ط°ظٹ ظٹط¨ط¯ط¯ ط§ظ„ط¸ظ„ط§ظ…...',
    },
  ],
  submissions: [],
  notifications: [],
...
const currentBrailleDots = new Set();
let selectedQuizId = null;
let ttsEngineMode = localStorage.getItem('cloudSchoolTtsEngine') || 'browser';
let activeAudioElement = null;
let currentUserSession = null;
let currentAgeLevel = localStorage.getItem('cloudSchoolAgeLevel') || 'auto';
...
function toggleTtsEngine() {
  ...
  if (btn) {
    btn.textContent =
      ttsEngineMode === 'gemini' ? `ًںژ™ï¸ڈ ${__('ttsGemini')}` : `ًںژ™ï¸ڈ ${__('ttsBrowser')}`;
  }
...
function toggleAgeLevel() {
  ...
  const labels = {
    auto: __('ageLevelAuto'),
    child: __('ageLevelChild'),
    teen: __('ageLevelTeen'),
    adult: __('ageLevelAdult'),
  };
...
function updateAgeLevelButton() {
  ...
  if (btn) {
    btn.textContent = __('ageButton', labels[currentAgeLevel] || __('ageLevelAuto'));
  }
}

function getAgeTone() {
  const age = currentUserSession?.age || 14;
  switch (currentAgeLevel) {
    case 'child':
      return 'ط§ط³طھط®ط¯ظ… ط£ط³ظ„ظˆط¨ط§ظ‹ ظ…ط¨ط³ط·ط§ظ‹ ط¬ط¯ط§ظ‹ ظ…ظ†ط§ط³ط¨ط§ظ‹ ظ„ظ„ط£ط·ظپط§ظ„طŒ ظ…ط¹ ط£ظ…ط«ظ„ط© ظٹظˆظ…ظٹط© ظ…ظ„ظ…ظˆط³ط©طŒ ظˆطھط´ط¬ظٹط¹ ظ…ط³طھظ…ط±.';
    case 'teen':
      return 'ط§ط³طھط®ط¯ظ… ط£ط³ظ„ظˆط¨ط§ظ‹ ط´ط¨ط§ط¨ظٹط§ظ‹ ظ…ظ†ط§ط³ط¨ط§ظ‹ ظ„ظ„ظ…ط±ط§ظ‡ظ‚ظٹظ†طŒ ظ…ط¹ طھط­ط¯ظٹط§طھ ظپظƒط±ظٹط© ظ…ظ†ط§ط³ط¨ط©طŒ ظˆظ„ط؛ط© ظˆط§ط¶ط­ط© ظ„ظƒظ†ظ‡ط§ ط؛ظٹط± ط·ظپظˆظ„ظٹط©.';
    case 'adult':
      return 'ط§ط³طھط®ط¯ظ… ط£ط³ظ„ظˆط¨ط§ظ‹ ط£ظƒط§ط¯ظٹظ…ظٹط§ظ‹ ط±طµظٹظ†ط§ظ‹ ظ…ظ†ط§ط³ط¨ط§ظ‹ ظ„ظ„ط¨ط§ظ„ط؛ظٹظ†طŒ ظ…ط¹ طھط­ظ„ظٹظ„ ط¹ظ…ظٹظ‚ ظˆظ…طµط·ظ„ط­ط§طھ ط¯ظ‚ظٹظ‚ط©.';
    default:
      if (age < 12) {
        return 'ط§ط³طھط®ط¯ظ… ط£ط³ظ„ظˆط¨ط§ظ‹ ظ…ط¨ط³ط·ط§ظ‹ ط¬ط¯ط§ظ‹ ظ…ظ†ط§ط³ط¨ط§ظ‹ ظ„ظ„ط£ط·ظپط§ظ„.';
      }
      if (age < 18) {
        return 'ط§ط³طھط®ط¯ظ… ط£ط³ظ„ظˆط¨ط§ظ‹ ظ…ظ†ط§ط³ط¨ط§ظ‹ ظ„ظ„ظ…ط±ط§ظ‡ظ‚ظٹظ†طŒ ظˆط§ط¶ط­ ظˆط¬ط°ط§ط¨.';
      }
...
function toggleScreenReaderMode() {
  ...
  if (screenReaderMode) {
    ...
    const ariaLive = document.getElementById('aria-live');
    if (ariaLive) {
      ariaLive.textContent = __('srModeActive');
    }
  } else {
...
function setTheme(theme) {
  ...
  body.classList.add(
    `theme-${theme === 'dark-hc' ? 'dark-high-contrast' : theme === 'light-hc' ? 'light-high-contrast' : 'classic'}`,
  );
...
function cycleTheme() {
  ...
  const current = localStorage.getItem(STORAGE_KEYS.theme) || 'dark-hc';
  const idx = themes.indexOf(current);
  const next = themes[(idx + 1) % themes.length];
  setTheme(next);
  const labels = {
    'dark-hc': __('themeDarkHC'),
    'light-hc': __('themeLightHC'),
    classic: __('themeClassic'),
  };
...
async function syncDataFromServer() {
  ...
  try {
    ...
    if (assignments && assignments.length > 0) {
      localData.assignments = assignments;
    }
    if (submissions && submissions.length > 0) {
      localData.submissions = submissions;
    }
    if (students && students.length > 0) {
      localData.students = students;
    }
    saveLocalData();
  } catch (e) {
...
function getArabicRoleName(role) {
  const roles = {
    student: __('roleStudent'),
    parent: __('roleParent'),
    teacher: __('roleTeacher'),
    admin: __('roleAdmin'),
  };
...
async function translateAndEvaluateBrailleWithAI() {
  ...
  try {
    const resultText = await callGeminiAPI(
      ...
      getPrompt(
        getCurrentLang(),
        'ط£ظ†طھ ظ…ط¹ظ„ظ… ظ„ط؛ط© ط¹ط±ط¨ظٹط© ظ…طھظ…ظٹط² ظˆط®ط¨ظٹط± ظپظٹ طھط±ط¬ظ…ط© ظˆطھطµط­ظٹط­ ظ„ط؛ط© ط¨ط±ط§ظٹظ„ ظˆط·ط±ظٹظ‚ط© Perkins ظ„ظ„ظ…ظƒظپظˆظپظٹظ† ظ…ظ† ط¬ظ…ظٹط¹ ط§ظ„ظ…ط±ط§ط­ظ„ ط§ظ„ط¹ظ…ط±ظٹط©. ',
...
async function summarizeCurriculumBookWithAI() {
  ...
  try {
    const resultText = await callGeminiAPI(
      ...
      getPrompt(
        getCurrentLang(),
        'ط£ظ†طھ ط®ط¨ظٹط± طھط¹ظ„ظٹظ…ظٹ ظ…طھظ…ظٹط² ظپظٹ طµظٹط§ط؛ط© ظˆطھظ„ط®ظٹطµ ط§ظ„ظ…ظ†ط§ظ‡ط¬ ط§ظ„ط¯ط±ط§ط³ظٹط© ظ„ط¶ط¹ط§ظپ ط§ظ„ط¨طµط± ط¨ط·ط±ظٹظ‚ط© ط³ظ…ط¹ظٹط© ظ…ط¨ط³ط·ط© ظ„ظ„ط؛ط§ظٹط©.',
...
const perkinsKeyupHandler = (e) => {
  if (document.getElementById('perkins-braille-keyboard').classList.contains('hidden')) {
    return;
  }
...
function playBookAudio(bookId) {
  ...
  if (book) {
    ...
    document.getElementById('audiobook-playing-title').textContent = __(
      'listeningToBook',
      book.title,
    );
...
function submitQuizAnswer() {
  ...
  addNotification(
    __('notifNewAnswer'),
    `${submission.studentName} ${__('notifQuizDone')} ${submission.quizTitle || ''} ${__('notifScored')} ${score}%`,
    'submission',
  );
  if (score >= 80) {
    addNotification(
      __('notifAchievement'),
      `${submission.studentName} ${__('notifScoredAchievement')} ${score}% ${__('notifInQuiz')} ${submission.quizTitle || ''}!`,
      'achievement',
    );
  }
...
function processPerkinsChord() {
  const dots = [];
  if (perkinsKeysPressed['f']) {
    dots.push(1);
  }
  if (perkinsKeysPressed['d']) {
    dots.push(2);
  }
  if (perkinsKeysPressed['s']) {
    dots.push(3);
  }
  if (perkinsKeysPressed['j']) {
    dots.push(4);
  }
  if (perkinsKeysPressed['k']) {
    dots.push(5);
  }
  if (perkinsKeysPressed['l']) {
    dots.push(6);
  }
...
function handleTeacherAddQuiz(e) {
  ...
  const newQuiz = { id: `a${localData.assignments.length + 1}`, title, type };
...
function saveBookToFirebase(book) {
  if (serverAvailable) {
    serverSave('curriculum_modules', book).catch(() =>
...
async function initServerBackend() {
  ...
  if (serverAvailable) {
    ...
    if (user) {
      ...
      document.getElementById('active-user-badge').textContent = __(
        'userBadge',
        user.name,
        getArabicRoleName(user.role),
      );
...
function dismissSplashScreen() {
  ...
  const handler = function () {
    ...
    setTimeout(function () {
      ...
      if (authGate) {
        const firstInput = authGate.querySelector('input, button, [tabindex]:not([tabindex="-1"])');
        if (firstInput) {
          firstInput.focus();
        }
      }
